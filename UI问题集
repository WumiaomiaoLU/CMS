...
顶部（logo、导航栏、banner）、正文（显示大部分需要展示的信息）、底部（包含了网页的版权、审批、声明等信息）    
7. 页面顶部一般都包含哪三部分  
logo、导航栏、banner  
8. 确定栏目形式的宗旨为？  
很好的表达栏目功能，以及想展示的内容  
...
4. 指示标是？其作用？  
指示当前浏览器的页面是哪一个页面，告诉用户当前访问的位置    
5. 什么是面包屑？面包屑的作用：  
面包屑导航的作用是告诉访问者他们目前在网站中的位置以及如何返回。指示访问的路径  
6. 什么是级联菜单？  
指有多个层级的菜单，每个级别的菜单，有与之相关联的自己菜单  
7. 级联菜单的好处？  
筛选时不用分割 层次结构清晰  
# 六  
1. 好的网页的标准?  
是什么网站、网站上有什么、网站可以做什么
2. 合格的网页是什么，具有哪些特点？  
- 美观舒适的风格  
- 高效的导航  
- 符合大众化习惯的布局  
